...
<footer class="footer-section">
    <div class="container relative">
        ...
        <!--<div class="sofa-img">
            <img src="../images/mbti.png" alt="Image" class="img-fluid">
        </div>-->

        <div class="row">
            <div class="col-lg-8">
                <div class="subscription-form">
                    <h3 class="d-flex align-items-center"><span class="me-1"><img src="images/envelope-outline.svg" alt="Image" class="img-fluid"></span><span>Đăng kí nhận tin</span></h3>
