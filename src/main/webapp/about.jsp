			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-lg-4 mb-5 mb-md-0">
						<img src="images/siunhan/gaovang.jpg" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">Nguyễn Quỳnh</span> Như Ý</a></h3>
					...
					<!-- Start Column 2 -->
					<div class="col-12 col-lg-4 mb-5 mb-md-0">
						<img src="images/siunhan/gaodo.jpg" class="img-fluid mb-5">

						<h3 clas><a href="#"><span class="">Nguyễn</span> Ngọc Hằng</a></h3>
					...
					<!-- Start Column 2 -->
					<div class="col-12 col-lg-4 mb-5 mb-md-0">
						<img src="images/siunhan/gaoxanh.jpg" class="img-fluid mb-5">

						<h3 clas><a href="#"><span class="">Lê Hoàng</span> Anh Mỹ</a></h3>
						<span class="d-block position mb-4">Tác giả.</span>
